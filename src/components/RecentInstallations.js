    ...
    return (
        <div
            style={{
                ...
                paddingBlock: "5rem",
                backgroundImage:
                    "linear-gradient(to bottom, dodgerblue, blue) ",
                padding: "2rem",
                color: "white",
            }}
        >
            <div className="display-5" style={{ marginBottom: "5rem" }}>
                Recent Installations
            </div>
            <div
                className="row"
                style={{ marginInline: isMobile ? "0" : "4rem" }}
            >
